...
class PreferredExerciseViewModelTest {
    ...
    private fun createViewModel() {
        viewModel = PreferredExerciseViewModel(
    ...
    @Test
    fun `init - ViewModel 초기화 시 fetchInitialData가 호출된다`() = runTest {
    ...
    @Test
    fun `fetchInitialData - 성공 시 exerciseUiModels가 업데이트된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(samplePreferredExercises)
    ...
    @Test
    fun `initNickname - 닉네임이 설정된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
    ...
    @Test
    fun `updateDaySelection - 해당 인덱스의 요일이 토글된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `updateSkillLevel - 스킬 레벨이 설정된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `updateSkillLevel - 동일한 스킬 레벨 선택 시 null로 토글된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `updateSelectedExercise - 운동 선택이 토글된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `completePreferredExerciseChanges - 선택된 운동 없으면 NoneSelected 상태가 된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `completePreferredExerciseChanges - 요일이나 숙련도 누락 시 IncompleteSelection 상태가 된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `completePreferredExerciseChanges - 변경사항 없으면 NoChanges 상태가 된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(samplePreferredExercises)
    ...
    @Test
    fun `completePreferredExerciseChanges - 새 운동 추가 시 createUseCase가 호출된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `completePreferredExerciseChanges - 운동 삭제 시 deleteUseCase가 호출된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(samplePreferredExercises)
    ...
    @Test
    fun `completePreferredExerciseChanges - API 에러 시 Error 상태가 된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `consumeCompletionState - 상태가 Idle로 리셋된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(emptyList())
    ...
    @Test
    fun `selectedExerciseUiModels - 선택된 운동만 필터링된다`() = runTest {
        coEvery { mockGetPreferredExerciseTypesUseCase() } returns BaseResult.Success(sampleExerciseTypes)
        coEvery { mockGetPreferredExerciseUseCase() } returns BaseResult.Success(samplePreferredExercises)

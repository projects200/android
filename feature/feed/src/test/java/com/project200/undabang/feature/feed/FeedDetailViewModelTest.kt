...
class FeedDetailViewModelTest {
    ...
    @Test
    fun `setFeedId - 내 피드인 경우 isMyFeed가 true`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `setFeedId - 다른 사람의 피드인 경우 isMyFeed가 false`() =
        runTest {
            // Given
    ...
    @Test
    fun `setFeedId - 피드 로드 실패 시 토스트 이벤트를 발생시킨다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
    ...
    @Test
    fun `deleteFeed - 삭제 성공 시 feedDeleted 이벤트를 발생시킨다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `createComment - 댓글 생성 성공 시 목록을 새로고침한다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `deleteComment - 삭제 성공 시 목록을 새로고침한다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `toggleFeedLike - 좋아요 토글 시 로컬 상태가 즉시 업데이트된다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `toggleFeedLike - 좋아요 취소 시 카운트가 감소한다`() =
        runTest {
            // Given
    ...
    @Test
    fun `toggleCommentLike - 댓글 좋아요 토글 성공`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)
    ...
    @Test
    fun `toggleCommentLike - 좋아요 실패 시 상태를 롤백한다`() =
        runTest {
            // Given
            coEvery { getMemberIdUseCase() } returns "member1"
            coEvery { getFeedDetailUseCase(1L) } returns BaseResult.Success(sampleFeed)

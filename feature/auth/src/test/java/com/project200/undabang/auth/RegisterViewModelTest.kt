...
class RegisterViewModelTest {
    ...
    @Test
    fun `updateNickname - 닉네임 업데이트 시 StateFlow가 변경된다`() {
    ...
    @Test
    fun `updateBirth - 생년월일 업데이트 시 StateFlow가 변경된다`() {
    ...
    @Test
    fun `selectGender - 성별 선택 시 StateFlow가 변경된다`() {
        val testGender = "MALE"

...
class SimpleTimerViewModelTest {
    ...
    @Test
    fun `init - ViewModel 생성 시 타이머 목록을 로드한다`() = runTest {
        // When
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `loadTimerItems - 성공하면 타이머 목록이 설정된다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `loadTimerItems - 실패하면 GET_ERROR 토스트가 발생한다`() = runTest {
        // Given
        coEvery { mockGetSimpleTimersUseCase() } returns BaseResult.Error("ERROR", "로드 실패")
        viewModel = SimpleTimerViewModel(
            simpleTimerServiceManager = mockSimpleTimerServiceManager,
            getSimpleTimersUseCase = mockGetSimpleTimersUseCase,
            addSimpleTimerUseCase = mockAddSimpleTimerUseCase,
            editSimpleTimerUseCase = mockEditSimpleTimerUseCase,
    ...
    @Test
    fun `addTimerItem - 성공하면 타이머가 추가된다`() = runTest {
        // Given
    ...
    @Test
    fun `addTimerItem - 실패하면 ADD_ERROR 토스트가 발생한다`() = runTest {
        // Given
    ...
    @Test
    fun `addTimerItem - 최대 개수에 도달하면 추가되지 않는다`() = runTest {
        // Given
    ...
    @Test
    fun `deleteTimerItem - 성공하면 타이머가 삭제된다`() = runTest {
        // Given
    ...
    @Test
    fun `deleteTimerItem - 실패하면 DELETE_ERROR 토스트가 발생한다`() = runTest {
        // Given
    ...
    @Test
    fun `updateTimerItem - 성공하면 타이머가 수정된다`() = runTest {
        // Given
    ...
    @Test
    fun `updateTimerItem - 실패하면 EDIT_ERROR 토스트가 발생한다`() = runTest {
        // Given
    ...
    @Test
    fun `updateTimerItem - 존재하지 않는 타이머는 수정되지 않는다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `changeSortOrder - 오름차순으로 정렬된다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `changeSortOrder - 두 번 호출하면 다시 오름차순이 된다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `setAndStartTimer - 서비스가 없으면 아무 동작도 하지 않는다`() = runTest {
        // Given
        viewModel = createViewModel()
    ...
    @Test
    fun `unbindService - 서비스 매니저의 bindService가 호출된다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `isTimerRunning - 초기값은 false이다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
    ...
    @Test
    fun `remainingTime - 초기값은 0이다`() = runTest {
        // Given
        viewModel = createViewModel()
        testDispatcher.scheduler.advanceUntilIdle()
